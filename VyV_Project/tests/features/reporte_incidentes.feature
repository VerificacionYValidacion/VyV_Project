...
Característica: Reportar problemas
  ...
  Como usuario
  deseo reportar un problema sucedido en mi ciudad especificando el lugar, el tipo de incidente y cualquier dato que me permita explicar el acontecimiento sucedido
